...
"Comparison with New York's 2018 Senate county table (NY State Board of Elections; identical to America Votes 33): after the fix the county totals equal the official table in 52 of 59 counties (within 0.1%) and Bronx, Queens and Tompkins agree",
...
"Idaho Secretary of State Elections Database", "ID", "1990;1992;2022", "HE",
"Idaho House county rows for 1990 and 1992 were missing and 2022 had 43 of 44 counties (MEDSL). They come from the Secretary of State's Elections Database county-level CSV exports (Ada County is in both districts and is summed); the 43 existing 2022 counties are identical",
"Candidate votes equal each county's 'Total Votes Cast' row in every county and district",
"Added 88 county-years (1990, 1992) and re-covered 2022 (43 identical, 1 added) (01fm_house_county_idaho_canvass.R; 01fn_idaho_apply.R)",
"fixed", "89 county-years", "R/data_creation/01fm_house_county_idaho_canvass.R; 01fn_idaho_apply.R", "2026-09-24",

"Wyoming Secretary of State", "WY", "1996;1998;2006", "HE",
"Wyoming House county rows for 1996, 1998 and 2006 were missing. They come from the Secretary of State's statewide general-election PDFs (text layer): the at-large U.S. Representative table by county",
"Every candidate's 23 county rows equal the printed totals",
"Added 69 county-years (01fo_wyoming_parse.py; 01fp_house_county_wyoming.R; 01fq_wyoming_apply.R)",
"fixed", "69 county-years", "R/data_creation/01fo_wyoming_parse.py; 01fp_house_county_wyoming.R; 01fq_wyoming_apply.R", "2026-09-24",

"North Carolina State Board of Elections (archived files)", "NC", "1996;1998", "HE",
"North Carolina House county rows for 1996 and 1998 were missing. They come from the Board's archived result files in a public storage bucket (1996: district tables printed from the old results site; 1998: one PDF per district with county TOTALS lines); split counties are summed over the districts",
"1996 county rows tie to each district's printed Total row and to the FEC's candidate totals; 1998 county TOTALS lines tie to each district's GRAND TOTALS",
"Added 200 county-years (01fr_northcarolina_1996_1998_parse.py; 01fs_house_county_northcarolina_1996_1998.R; 01ft_northcarolina_apply.R)",
"fixed", "200 county-years", "R/data_creation/01fr_northcarolina_1996_1998_parse.py; 01fs_house_county_northcarolina_1996_1998.R; 01ft_northcarolina_apply.R", "2026-09-24",

"South Carolina State Election Commission (ENR archive)", "SC", "2010", "HE",
"South Carolina House county rows for 2010 were missing (the only South Carolina gap). They come from the Commission's 2010 election-night-reporting archive workbook (U.S. House Districts 1-6 by county); the file has no party column, so the Democratic and Republican nominees were identified from the FEC results",
"All six district Democratic and Republican totals and the statewide total (1,340,189) equal the FEC's official results; sums tie to each sheet's Totals row",
...
"Added 112 county-years (01gt_montana_1990_transcribe.py; 01gu_house_county_montana_1990.R; 01gq_montana_1994_parse.py; 01gr_house_county_montana_1994.R; 01gs_montana_1994_apply.R)",
"fixed", "112 county-years", "R/data_creation/01gt_montana_1990_transcribe.py; 01gq_montana_1994_parse.py; 01gs_montana_1994_apply.R", "2026-09-24",

"Wyoming Secretary of State (Internet Archive microfiche)", "WY", "1990;1992;1994", "HE",
"Wyoming House county rows for 1990, 1992 and 1994 were missing. They are hand-transcribed from the Official Vote / Official Summary tables of the Secretary of State's Official Directory and Election Returns volumes (Internet Archive Statistical Reference Index microfiche scans)",
"The 23 county rows add up to the printed Official Totals of every candidate; the 1990 and 1992 totals equal the FEC's official results",
"Added 69 county-years (01gv_wyoming_1990_1994_transcribe.py; 01gw_house_county_wyoming_1990_1994.R; 01gx_wyoming_1990_1994_apply.R)",
"fixed", "69 county-years", "R/data_creation/01gv_wyoming_1990_1994_transcribe.py; 01gw_house_county_wyoming_1990_1994.R; 01gx_wyoming_1990_1994_apply.R", "2026-09-24",
...
"Added 3 county-years (01fw_house_county_delaware_2012.R; 01fx_delaware_apply.R)",
"fixed", "3 county-years", "R/data_creation/01fw_house_county_delaware_2012.R; 01fx_delaware_apply.R", "2026-09-24",

"Montana Secretary of State (canvass PDFs via the Wayback Machine)", "MT", "1992;1996;1998", "HE",
"Montana House county rows for 1992, 1996 and 1998 were missing. They come from the Secretary of State's official general-election canvass PDFs (wide tables split over pages; the 1996 and 1998 House columns lie on pages without county names and are matched to counties by row order)",
"Every candidate's 56 county values equal the printed statewide total; county House votes are 83-99% of votes cast (alignment check); 1992 and 1996 candidate totals equal the FEC",
"Added 168 county-years (01fy_montana_1992_1998_parse.py; 01fz_house_county_montana_1992_1998.R; 01ga_montana_apply.R)",
"fixed", "168 county-years", "R/data_creation/01fy_montana_1992_1998_parse.py; 01fz_house_county_montana_1992_1998.R; 01ga_montana_apply.R", "2026-09-24",
...
"Added 575 county-years (01fh_house_county_missouri_1990_1998.R; 01fi_missouri_apply.R)",
"fixed", "575 county-years", "R/data_creation/01fg_missouri_1990_1998_parse.py; 01fh_house_county_missouri_1990_1998.R; 01fi_missouri_apply.R", "2026-09-23",
...
"Added 88 county-years (1996) and replaced 88 county-years (2002; 1 changes) (01fc_ohio_sos_archive_apply.R)",
"replaced", "176 county-years", "R/data_creation/01fb_house_county_ohio_sos_archive.R; 01fc_ohio_sos_archive_apply.R", "2026-09-23",

"MA Secretary of the Commonwealth Elections Statistics", "MA", "1990-2014", "HE",
"Massachusetts House county rows for 1990-2014 (every even year) now come from the Secretary of the Commonwealth's Elections Statistics site (town tables summed to the 14 counties). They add 1990, 1992, 1994, 1996 (13 of 14 counties: Sutton has no rows), 1998 and REPLACE the OpenElections rows of 2000-2014 (2002-2008 and 2014 identical; 2000: four counties lacked the Republican candidate (Travis) because the OpenElections town files omit that column; 2010: two counties differ by up to 0.1 points; 2012: 13 of 14 counties). In the site's own tables: 2000 CD4 omits Martin D. Travis's (Republican) column although Total Votes Cast includes it (reconstructed per town as Total minus the listed cells; the residuals add up to exactly his FEC total 56,553) and 1996 CD10 Sandwich's Teague cell is 180 short of the TOTALS row (repaired; his FEC total 123,523 equals the TOTALS row)",
"TOTALS row of every table (town rows tie in all 129 contests after the two repairs); FEC official district results (R/qa_state_reconcile_congress.R, 2004-2014; federalelections00.pdf and federalelections96.pdf for the two repairs)",
"Added 70 county-years and replaced 111 county-years (01ez_massachusetts_electionstats_apply.R). Terms caution: the Secretary's Terms and Conditions prohibit scraping or crawling by automated means; the tables were fetched with a script; reuse permission not requested, included by project decision (public facts)",
"replaced", "181 county-years", "R/data_creation/01ey_house_county_massachusetts_electionstats.R; 01ez_massachusetts_electionstats_apply.R", "2026-09-23",

"Washington Secretary of State", "WA", "2008;2010", "HE",
"Washington House county rows for 2008 were missing (the OpenElections repo has no 2008 file) and 2010 had 37 of 39 counties: the OpenElections 2010 precinct file misspells Wahkiakum ('Wahkiukum') and Pend Oreille ('Pend O'reille'), so both failed the county match and were dropped. The same file has errors: King County CD9 has the candidates swapped (Smith 39,757 / Muri 59,201; the SOS file has Smith 59,201 / Muri 39,757), Skamania CD3 has Heck and Herrera Beutler swapped, Snohomish CD2 has Larsen and Koster mixed (about 2,200 votes), and Pierce CD6 / CD9 miss votes that Pierce suppresses in precinct cells for voter privacy (the printed Contest Total is complete). 2008 and 2010 now come from the Secretary of State's General Election data downloads (39 counties each)",
"2008: county sums equal the printed district totals for all 18 candidates; 2010: district totals equal the FEC's official Democratic and Republican votes in all 9 districts (they differed in CD2, CD3, CD6 and CD9 before)",
"Added 39 county-years (2008); replaced 37 county-years and added 2 (2010) (01ev_washington_sos_apply.R); 4 of the 39 counties' 2010 shares change (King, Pierce, Skamania, Snohomish)",
"replaced", "78 county-years", "R/data_creation/01eu_house_county_washington_sos.R; 01ew_washington_2010_sos_precinct.R; 01ev_washington_sos_apply.R", "2026-09-23",

"CT Secretary of the State Election History", "CT", "1990-2014", "HE",
"Connecticut House county rows for 1990-2014 (every even year) now come from the Secretary of the State's Election History database (town tables summed to the 8 counties). They add 1990, 1992, 1994, 1996, 1998 (5 of 8 counties: CD1 was uncontested and is not in the database), 2004 and 2014 (no rows before) and REPLACE the OpenElections rows of 2000, 2002, 2006, 2008, 2010 and 2012 (2012 had 3 of 8 counties; the 2002 rows lacked a Democratic party label for Courtney in CD2 in the source; 2010 shares differed by up to 1.6 points). In the database itself: 1998 CD3 David P. Cole is labelled Republican (FEC: Reform; relabelled), 2002 CD2 Joe Courtney has a blank party (Democratic per FEC; relabelled), 2008 CD3 Bo Itshaky's district-row cell (26,432) contradicts his town rows (58,583; the printed district total agrees with the town rows), 1994 CD5 Woodbridge candidate cells exceed the printed town total by 200, and write-in votes printed only on the district row (2004 CD2 and CD4, 2008 CD2) are not in the county rows",
"District rows of the same tables; FEC official district results (R/qa_state_reconcile_congress.R, 2004-2014) and FEC 1998 results for the party labels",
"Added 58 county-years and replaced 43 county-years (01et_connecticut_elstats_apply.R); literal ballot-line party classification as in the earlier build",
"replaced", "101 county-years", "R/data_creation/01es_house_county_connecticut_elstats.R; 01et_connecticut_elstats_apply.R", "2026-09-23",

"NY State Board of Elections", "NY", "1996-2018", "HE",
"New York House county rows for 1996-2018 (every even year) now come from the NY State Board of Elections Elections Database, one table per congressional district. They add 1996, 1998, 2002, 2008 and 2010 (no rows before) and REPLACE the OpenElections rows of 2000, 2004, 2006, 2012 and 2014 and the MEDSL rows of 2016 and 2018. Replaced rows had missing counties (2012: 58 of 62; 2016: 61 of 62; 2018: 47 of 62 counties in the panel) and errors (2000: Bronx and Queens totals 17% and 26% above the official county tables and a different party split; 2004 Kings share). In the database itself, a duplicate 'Otsego' county row (a cell-for-cell copy of the district's Oswego row) appears in 2010 CD24 and in 2012-2018 CD22 and CD24 and is dropped; 1996 has no Oswego rows (61 of 62 counties); 2000 CD13 spells Fossella two ways (merged)",
"District rows of the same tables and FEC official district results (R/qa_state_reconcile_congress.R); county rows tie to the printed district row in every column of all 346 contests",
"Added 327 county-years and replaced 416 county-years (01eq_new_york_boe_apply.R); blank/void/scattering are not counted as votes",
"replaced", "743 county-years", "R/data_creation/01ep_house_county_new_york_boe.R; 01eq_new_york_boe_apply.R", "2026-09-23",

"NY State Board of Elections", "NY", "2018", "SE",
"Three New York 2018 Senate counties (Jefferson, Niagara, Ulster) are missing from MEDSL; filled from the NY State Board of Elections Elections Database county table for the 2018 U.S. Senate general election (all 62 counties tie to the statewide row; first filled on 2026-09-21 from America Votes 33, whose numbers are identical, and re-sourced to the official table on 2026-09-23). The table's candidate totals combine all party lines (Gillibrand: Democratic + Working Families + Independence + Women's Equality), while the MEDSL-based counties count the Democratic and Republican lines only, so these three counties' Democratic/Republican shares are slightly higher than a line-based count",
"NY State Board of Elections, statewide row",
"Added 3 county-years (01dg_ny_senate_2018_boe_apply.R); the rest of New York keeps the MEDSL line-based counts",
"fixed", "3 county-years added", "R/data_creation/02b2_senate_ny_2018_boe.R; 01dg_ny_senate_2018_boe_apply.R", "2026-09-21",

"MEDSL", "NY", "2018", "SE",
"Even after the fix, four New York counties differ from the official NY State Board of Elections table by more than 1%: Lewis (MEDSL 8,182 vs 8,830), Madison (22,367 vs 25,735), Wyoming (13,818 vs 13,170) and Nassau (491,668 vs 499,245); MEDSL's precinct data look incomplete or padded there",
"NY State Board of Elections county table",
"Left as MEDSL (the official table combines party lines, so a replacement would change the party definition within the state); flagged",
"flagged", "4 county-years", "R/data_creation/02b2_senate_ny_2018_boe.R", "2026-09-21",
