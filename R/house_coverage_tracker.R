...
MANUAL_NOTES <- tribble(
  ...
  "DELAWARE", NA,  "2012 (was a gap) from the Department of Elections' results archive (stwoff_kns.txt; 01fw_house_county_delaware_2012.R, 01fx_delaware_apply.R). The file's first column is headed \"Wilmington\" but holds New Castle County totals. 1990, 1992, 1994 and 1996 (were gaps) from the Department's image-only scanned \"Statewide Offices\" tables, hand-transcribed (01ge_delaware_1990_1996_transcribe.py, 01gf..., 01gg...): City of Wilmington + Rural New Castle = New Castle; every candidate and column ties to the printed totals. 1998 is published only by election district; not built.",
