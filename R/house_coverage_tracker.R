...
MANUAL_NOTES <- tribble(
  ...
  "NEW MEXICO",       NA,  "America Votes table exists in the book but wasn't matched by the parser (1992-2000 specifically); SOS site (sos.nm.gov) loads fine, not bot-blocked, just haven't located the actual results-archive subpage. 1994 and 1996 REPLACED 2026-09-24: 01ek had shifted/misfiled county columns and dropped minor candidates; 1994 from the canvass on SRI microfiche (01il), 1996 re-transcribed (01ir).",
  ...
  "FLORIDA",          NA,  "Legacy ASP/frames site (results.elections.myflorida.com), not bot-blocked, just needs someone to navigate ElectionRaces.asp/TitlePage.asp for a given year/county. 1990 (was a gap) from the Division of Elections' 1990 results on SRI microfiche, with county absentee ballots (01ik; 01io/01ip); 1994 from the same collection equals the existing rows (verification copy only).",
  ...
  "WYOMING", NA,  "1996, 1998 and 2006 (were gaps) from the SOS statewide general-election PDFs (sos.wyo.gov; text layer; 01fo_wyoming_parse.py, 01fp_house_county_wyoming.R, 01fq_wyoming_apply.R); 23 counties, ties to printed totals. 1990, 1992 and 1994 (were gaps) hand-transcribed from the Wyoming Official Directory and Election Returns volumes on Internet Archive microfiche (01gv_wyoming_1990_1994_transcribe.py, 01gw..., 01gx...): 23 counties, ties to the printed Official Totals (= the FEC in 1990 and 1992).",
  "NORTH CAROLINA", NA,  "1996 and 1998 (were gaps) from the State Board of Elections' archived result files in its public S3 bucket (not linked from the history page): 1996 a text PDF (district tables), 1998 one PDF per district with county TOTALS lines (01fr_northcarolina_1996_1998_parse.py, 01fs..., 01ft...); ties to district totals and the FEC. 1992 and 1994 (were gaps) from the State Board of Elections' typed abstracts scanned in the State Library digital collection (digital.ncdcr.gov; tesseract OCR with the misread cells settled by a second pass and the page images; 01gk_northcarolina_1992_1994_parse.py, 01gl..., 01gm...): every district ties to its printed TOTAL row and the FEC (District 10 1992 is 34 and 2 votes short as printed). 1990 (was a gap) from the North Carolina Manual 1991-1992 county tables (01je, 01jf, 01jg).",
  ...
  "DELAWARE", NA,  "2012 (was a gap) from the Department of Elections' results archive (stwoff_kns.txt; 01fw_house_county_delaware_2012.R, 01fx_delaware_apply.R). The file's first column is headed \"Wilmington\" but holds New Castle County totals. 1990, 1992, 1994 and 1996 (were gaps) from the Department's image-only scanned \"Statewide Offices\" tables, hand-transcribed (01ge_delaware_1990_1996_transcribe.py, 01gf..., 01gg...): City of Wilmington + Rural New Castle = New Castle; every candidate and column ties to the printed totals. 1998 is published only by election district; not built. 1998 (was a gap) from the Department of Elections results by election district summed to counties (01jk, 01jl, 01jm).",
  "SOUTH DAKOTA", NA,  "1992 (was a gap) from the Secretary of State's scanned 1992 general-election returns (1992G.pdf, page 5), hand-transcribed (01gb_southdakota_1992_transcribe.py, 01gc_house_county_southdakota_1992.R, 01gd_southdakota_apply.R): 66 counties, all five candidate columns tie to the printed totals.",
  "OREGON", NA,  "1990-1998, 2000, 2002, 2004 and 2012 (were gaps or partial) from the Secretary of State's Official Abstracts / Statistical Summaries in the State Library of Oregon digital collection (the 1996 document also holds the 1998 abstract; 01gn_oregon_parse.py, 01go..., 01gp...): all 36 counties, split counties summed over districts, every district ties to its printed TOTAL row, 1990 and 1992 equal the FEC. The earlier partial 2000/2002/2004/2012 rows had split counties (Marion, Lane, Benton, Linn) with one district only and were replaced.",
  "NORTH DAKOTA", NA,  "1990, 1992, 1994, 1996 and 1998 (were gaps) from the Secretary of State's scanned Official Abstract of Votes Cast (two-page county abstracts, embedded OCR text layer read by word position; 01gh_northdakota_1990_1998_parse.py, 01gi..., 01gj...): 53 counties per year, every candidate column ties to the printed statewide total (= the FEC total in 1990, 1992, 1996, 1998).",
  "TENNESSEE", NA,  "1998 (was a gap) from the Secretary of State's archived county report (image-only PDF downloaded by hand; OCR keyed and checked, 01gy_tennessee_1998_parse.py, 01gz..., 01ha...): 95 counties, every district ties to its printed total and the FEC. 1996 (was a gap) from the Tennessee Blue Book 1997-1998, double-keyed (page-image transcription + PDF text layer; 01hf, 01hh, 01hi, 01hj): 95 counties, ties to printed totals and the FEC. 1990, 1992, 1994 (were gaps) from the Blue Books 1991-1994 and 1995-1996, checked against the certification typescript on SRI microfiche (review tool 01hb-01hd; 01hk, 01hl, 01hm): four Blue Book cells replaced by the certification, every column ties to the certified totals and the FEC.",
  "ARKANSAS",      NA,  "2004 (was a gap) from the SOS certification report, districts 1-3; district 4 unopposed (01jk, 01jl, 01jm).",
  "MISSISSIPPI",     NA,  "1994 (was a gap) from the Secretary of State's certification on SRI microfiche (01il; 01io/01ip). 1996 still open.",
  "NEW HAMPSHIRE",   NA,  "1990 and 1992 (were gaps) from the Manual for the General Court on SRI microfiche, towns summed to counties (01iq; 01io/01ip). 1994, 1998, 2002, 2004, 2008 (were gaps) from the Manual for the General Court town tables (01jh, 01ji, 01jj; 01jn/01jo). New Hampshire now complete 1990-2024.",
  "MONTANA", NA,  "1992, 1996 and 1998 (were gaps) from the SOS official general-election canvass PDFs recovered from the Wayback Machine (sos.mt.gov 1990s archive; text layers of a wide table split over pages; 01fy_montana_1992_1998_parse.py, 01fz..., 01ga...): 56 counties; candidate totals tie to the printed statewide totals and the FEC; 1996 and 1998 columns are matched to counties by row order and checked against votes cast. 1990 (scanned canvass sheet, two districts, hand-transcribed; 01gt_montana_1990_transcribe.py, 01gu...) and 1994 (Lotus worksheet from the Wayback Machine; 01gq_montana_1994_parse.py, 01gr..., 01gs...) were added later; 2022 remains. 2022 (was a gap: MEDSL rows carry an empty mode and were dropped by 01a) summed directly from MEDSL, candidates equal the FEC (01iv, 01iw).",
  "OKLAHOMA",        NA,  "1998 (was a gap) from the State Election Board's results page as archived by the Wayback Machine (98gencon.html; 01fj_oklahoma_1998_parse.py, 01fk_house_county_oklahoma_1998.R, 01fl_oklahoma_1998_apply.R): every candidate in every county of each of the 6 districts, county rows tie to the STATE TOTAL lines and the district totals equal the FEC results. 1990, 1992 and 1996 (were gaps) from the Board's annual 'State of Oklahoma Election Results and Statistics' books (1990/1992: Internet Archive SRI microfiche; 1996: ODL Digital Prairie, which holds the series 1978-2008; 01ib, 01ic, 01id, 01ie), tied to printed totals and the FEC. 1994 and 2000 onward as before.",
