...
- **Survey of untried states and "Tier 1" builds (2026-09-24):** four read-only research agents surveyed the official and archived sources for the House gap years of Delaware, Idaho, Montana, New Hampshire, North Carolina, North Dakota, Oregon, South Carolina, South Dakota, Tennessee, Texas and Wyoming. Built from clean digital sources (each with its parse/build/apply scripts and checks; see the corrections log): **Idaho** 1990, 1992, 2022 (Idaho SOS Elections Database, county CSV exports), **Wyoming** 1996, 1998, 2006 (SOS text PDFs), **North Carolina** 1996, 1998 (State Board of Elections' public S3 bucket), **South Carolina** 2010 (ENR archive workbook; parties from the FEC), **Delaware** 2012 (Department of Elections text file), **Montana** 1992, 1996, 1998 (SOS canvass PDFs from the Wayback Machine). Remaining leads: Internet Archive microfiche for Texas 1990, Tennessee 1990-1994 and Wyoming 1990-1994; scanned PDFs for North Dakota 1990-1998, South Dakota 1992, Delaware 1990-1996, Tennessee 1998, North Carolina 1992-1994 and Montana 1990/1994; Oregon's State Library "Official abstract of votes" PDFs (1990-1996, 2000-2004, 2012); New Hampshire's NHPR database (terms ambiguous, permission to be sought). Unresolved: Tennessee 1996, Oregon 1998, Delaware 1998 (by election district only), Montana 2022 (browser exports).
- **Tier 2 scans, hand-transcribed (2026-09-24):** where the only source is an image-only PDF, the page image is read by eye into a `*_transcribe.py` script that stops unless every candidate row and every column ties to the printed totals (OCR is not used for values: it dropped counties and confused 5/6 in fax scans). **South Dakota** 1992 (66 counties, Secretary of State returns booklet, `01gb`-`01gd`) **North Dakota** 1990-1998 (Secretary of State abstracts, embedded OCR text layer read by word position, `01gh`-`01gj`), **North Carolina** 1992 and 1994 (typed abstracts scanned in the State Library digital collection, tesseract OCR corrected against a second pass and the images, `01gk`-`01gm`), **Oregon** 1990-1998, 2000, 2002, 2004, 2012 (State Library of Oregon copies of the Secretary of State abstracts; the library page says to contact it before reuse if unsure - election counts are public-record facts, flagged in the registry as not_stated), **Montana** 1990 (scanned canvass sheet, two districts) and 1994 (Lotus worksheet), **Wyoming** 1990-1994 (Directory volumes on Internet Archive microfiche), **Tennessee** 1998 (Secretary of State county report, OCR checked against images; the file host refuses curl, so the PDF was downloaded by hand), and **Delaware** 1990, 1992, 1994, 1996 (Department of Elections statewide-offices tables; City of Wilmington + Rural New Castle = New Castle County; `01ge`-`01gg`).
